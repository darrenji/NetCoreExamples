...
namespace DDD.Marketplace.Tests
{
    public class Money_Spec
    {
        ...
        [Fact]
        public void Two_of_same_amount_shoud_be_equal()
        {
        ...
        [Fact]
        public void Two_of_same_amount_but_differenctCurrencies()
        {
            var firstAmount = Money.FromDecimal(5, "EUR", CurrencyLookup);
        ...
        {
            Assert.Throws<ArgumentException>(() => Money.FromDecimal(100, "h",CurrencyLookup));
        }

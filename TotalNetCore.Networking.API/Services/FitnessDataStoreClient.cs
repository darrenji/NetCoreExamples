...
namespace TotalNetCore.Networking.API.Services
{
    ...
    {
        //readonly意味着只能通过构造函数或者显式设置
        //也就是readonly的字段对外界来说是Immutable
        private readonly IHttpClientFactory _httpFactory;

        public FitnessDataStoreClient(IHttpClientFactory httpClientFactory)
        {
